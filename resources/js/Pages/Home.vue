...
const goToDetail = (slug) => {
  activeCarSlug.value = slug.toLowerCase();
...
<template>
  <div class="min-h-screen bg-[#f9f9ff] text-[#111c2d] antialiased overflow-x-hidden w-full max-w-full">
    ...
    <!-- JIKA DI BERANDA: TAMPILKAN HOME LENGKAP -->
    <template v-else>
      ...
      <!-- NAVBAR AKTIF -->
      <Navbar currentPage="home" @select-car="goToDetail" />
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 space-y-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              ...
              <div class="bg-white p-5 sm:p-6 rounded-xl border border-slate-200 shadow-sm space-y-3">
                ...
                <p class="text-xs text-slate-500 leading-relaxed">Didukung pembiayaan terkemuka: Mandiri Tunas Finance, BCA Finance, BRI Finance, Suzuki Finance Indonesia, Indomobil Finance.</p>
              </div>
              ...
              <div class="bg-white p-5 sm:p-6 rounded-xl border border-slate-200 shadow-sm space-y-3">
                ...
                <p class="text-xs text-slate-500 leading-relaxed">Kemudahan servis berkala teknisi datang ke rumah Anda di Makassar serta perlindungan darurat towing 24 jam nonstop.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-12 border-b border-slate-800">
            <div class="space-y-4">
              ...
              <p class="text-xs text-slate-400 leading-relaxed">
                Dealer resmi 3S Suzuki Mobil wilayah Makassar dan Sulawesi Selatan dengan layanan purnajual terstandarisasi Suzuki Indonesia.
              </p>
            </div>
            <div class="space-y-3">
              <h4 class="font-bold text-sm text-white">Showroom & Bengkel 3S</h4>
              <p class="text-xs text-slate-400">Jl. Gunung Latimojong No. 96, Kota Makassar, Sulawesi Selatan 90141</p>
            </div>
            <div class="space-y-3">
              <h4 class="font-bold text-sm text-white">Mitra Pembiayaan Resmi</h4>
              <p class="text-xs text-slate-400">MTF, BCA Finance, BRI Finance, Suzuki Finance, Indomobil Finance.</p>
            </div>
            <div class="space-y-3">
              <h4 class="font-bold text-sm text-white">Kontak Personal</h4>
              <p class="text-xs text-slate-300">CHAE SUZUKI (Sales Executive) - 0852-9983-7635</p>
            </div>
          </div>
        </div>
      </footer>
